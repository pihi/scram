...
namespace Scram
{
  ...
  internal class ScramAttribute<TValue> : ScramAttribute
  {
  ...
  internal class UserAttribute : ScramAttribute<string>
  {
  ...
  internal class NonceAttribute : ScramAttribute<string>
  {
  ...
  internal class ChannelAttribute : ScramAttribute<string>
  {
  ...
  internal class ClientProofAttribute : ScramAttribute<byte[]>
  {
